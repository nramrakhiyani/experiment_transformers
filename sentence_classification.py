...
def test_bert_based_classification(test_data_path, model_path, data_preprocessing_required, test_predictions_path):
	#Reading data
	sentences = []
...
def evaluate_bert_based_classification(test_data_path, model_path, data_preprocessing_required, test_predictions_path):
